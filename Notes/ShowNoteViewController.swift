...
class ShowNoteViewController: UIViewController {
    ...
    // 27. Add Recommended note and Mandatory deligate class member
    ...
    // 31. Function to call shift controll to Add Edit Note Controller as Edit mode
    ...
    // 34. Func to pass controll to update note notes view func.
    ...
    // 29. Add Custom view to set note UI objects positions and values.
    func addCustomView(note: Note) {
        
        // 30. Add Nav Bar Edit button
